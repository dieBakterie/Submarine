summon armor_stand ~ ~ ~ {NoGravity:1b,Invulnerable:1b,Marker:1b,Invisible:1b,NoBasePlate:1b,Tags:["vehicle","sub","subspawn","sub2","color_{color}"],attributes:[{id:"minecraft:movement_speed",base:1.2},{id:"minecraft:movement_efficiency",base:1},{id:"minecraft:water_movement_efficiency",base:1}],DisabledSlots:4144959,Passengers:[{id:"minecraft:minecart",NoGravity:1b,Silent:1b,Invulnerable:1b,Tags:["sub2"],CustomName:'"subseat"'}],ArmorItems:[{},{},{},{id:diamond_hoe,count:1,components:{item_model:"submarine:submarines/{color}/{color}_submarine_1"}}],ArmorDropChances:[0.000F,0.000F,0.000F,0.000F],CustomName:'"sub"'}
summon armor_stand ~ ~ ~ {NoGravity:1b,Invulnerable:1b,Marker:1b,Invisible:1b,NoBasePlate:1b,Tags:["sub","sub2"],attributes:[{id:"minecraft:movement_speed",base:1.2},{id:"minecraft:movement_efficiency",base:1},{id:"minecraft:water_movement_efficiency",base:1}],DisabledSlots:4144959,Passengers:[{id:"minecraft:chest_minecart",NoGravity:1b,Silent:1b,Invulnerable:1b,Tags:["sub2"],CustomName:'"subchest"'}],CustomName:'"subback"'}

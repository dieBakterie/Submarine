...
output_dir = 'submarine/function/animations'
...
for color in colors:
    ...
    file_path = os.path.join(output_dir, f'{color}_submarine_animation.mcfunction')

    # Datei erstellen und öffnen
    with open(file_path, 'w') as file:
        # Füge den initialen Kommentart und Scoreboard-Befehl hinzu
        file.write(f'#// Description: This function is responsible for animating the {color} submarine.\n')
        ...
        for i in range(1, animations + 1):
            ...
            command_forward = (f'execute as @s[tag=subforward,tag=color_{color},scores={{animation={i}}}] run data merge entity @s {{ArmorItems:[{{}},{{}},{{}},{{id:"minecraft:diamond_hoe",count:1,components:{{custom_model_data:{animation_step}}}}}]}}\n')
        ...
        for i in range(1, animations + 1):
            ...
            command_backwards = (f'execute as @s[tag=subbackwards,tag=color_{color},scores={{animation={i}}}] run data merge entity @s {{ArmorItems:[{{}},{{}},{{}},{{id:"minecraft:diamond_hoe",count:1,components:{{custom_model_data:{animation_step}}}}}]}}\n')

...
execute as @e[name=sub,tag=subforward] at @s run function submarine:animation/animation
execute as @e[name=sub,tag=subbackwards] at @s run function submarine:animation/animation
...
execute as @e[name=sub] at @s run function submarine:color_trigger

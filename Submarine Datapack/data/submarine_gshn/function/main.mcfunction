...
execute as @a[tag=submariner] at @s as @e[type=item,distance=..2,limit=1,nbt={Item:{id:"minecraft:tnt",count:1}}] as @e[name=sub,distance=..2,limit=1,scores={subtorpedo=0,subenergy=1..}] at @s run function submarine_gshn:torpedo/torpedo_launch
execute as @e[name=subtorpedo] at @s run function submarine_gshn:torpedo/torpedo
execute as @e[name=sub,scores={subtorpedo=1..}] at @s run function submarine_gshn:torpedo/torpedo_reload
execute as @e[name=subtorpedo,tag=subtorpexplode] at @s run function submarine_gshn:torpedo/torpedo_explode
...
execute as @e[name=sub,tag=subforward] at @s run function submarine_gshn:animation/animation
execute as @e[name=sub,tag=subbackwards] at @s run function submarine_gshn:animation/animation_backwards
...
execute as @e[name=sub] at @s run function submarine_gshn:color_trigger

...
execute as @s[nbt={SelectedItemSlot:0}] run scoreboard players add @a[tag=submariner] animation 1
...
execute as @s[nbt={SelectedItemSlot:2}] run scoreboard players remove @s[tag=submariner,scores={animation=20..}] animation 1

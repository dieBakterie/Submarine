...
execute if score @s rptrain_sndcntr matches 3 run function trains_gshn:sound_rail
execute if score @s rptrain_sndcntr matches 3 run function trains_gshn:sound_engine_trigger
execute if score @s rptrain_sndcntr matches 3 run scoreboard players remove @s rptrain_sndcntr 1
execute if score @s rptrain_sndcntr matches ..0 run function trains_gshn:sound_rail
execute if score @s rptrain_sndcntr matches ..0 run function trains_gshn:sound_engine_trigger

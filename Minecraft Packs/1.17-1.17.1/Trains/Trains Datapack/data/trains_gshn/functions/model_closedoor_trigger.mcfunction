...
execute if entity @e[type=armor_stand,name=rptrain_model,tag=rptrain_closedoor,tag=!rptrain_closeddoor] as @e[type=armor_stand,name=rptrain_model,tag=rptrain_closedoor,tag=!rptrain_closeddoor] at @s run function trains_gshn:model_closedoor

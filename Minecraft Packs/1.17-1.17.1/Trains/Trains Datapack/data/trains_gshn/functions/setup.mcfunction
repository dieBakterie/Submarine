...
tellraw @a ["",{"text":"[Locomotive Eggs] ","bold":true,"color":"dark_green","clickEvent":{"action":"run_command","value":"/function trains_gshn:locomotive_eggs"}},{"text":"[Wagon Eggs]","bold":true,"color":"dark_green","clickEvent":{"action":"run_command","value":"/function trains_gshn:wagon_eggs"}},{"text":" ","bold":true,"color":"dark_green"},{"text":"[Structure Eggs]\n","bold":true,"color":"dark_green","clickEvent":{"action":"run_command","value":"/function trains_gshn:structure_eggs"}}]
tellraw @a ["",{"text":"          [Get the Train Controls Book]\n","bold":true,"color":"dark_green","clickEvent":{"action":"run_command","value":"/function trains_gshn:player_book"}}]

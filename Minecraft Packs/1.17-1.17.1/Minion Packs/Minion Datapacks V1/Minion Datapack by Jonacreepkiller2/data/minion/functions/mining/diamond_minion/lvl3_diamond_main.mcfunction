...
execute as @e[scores={dia_ore_counter=24},tag=lvl3] if entity @e[tag=diamond_selected] run function dp_by_j:mining/diamond_minion/diamond_minion/diamond/lvl3/lvl3_diamond_mining

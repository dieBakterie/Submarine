...
execute as @e[scores={glow_counter=24},tag=lvl3] if entity @e[tag=glowstone_selected] run function dp_by_j:mining/glowstone_minion/glowstone/lvl3/lvl3_glowstone_mining

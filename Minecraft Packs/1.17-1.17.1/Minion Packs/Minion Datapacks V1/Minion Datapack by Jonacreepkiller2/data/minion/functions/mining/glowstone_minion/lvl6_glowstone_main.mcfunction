...
execute as @e[scores={glow_counter=24},tag=lvl6] if entity @e[tag=glowstone_selected] run function dp_by_j:mining/glowstone_minion/glowstone/lvl6/lvl6_glowstone_mining

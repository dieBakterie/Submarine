...
execute as @e[scores={glow_counter=24},tag=lvl9] if entity @e[tag=glowstone_selected] run function dp_by_j:mining/glowstone_minion/glowstone/lvl9/lvl9_glowstone_mining

...
execute as @e[scores={dia_ore_counter=24},tag=lvl7] if entity @e[tag=diamond_selected] run function dp_by_j:mining/diamond_minion/diamond_minion/diamond/lvl7/lvl7_diamond_mining

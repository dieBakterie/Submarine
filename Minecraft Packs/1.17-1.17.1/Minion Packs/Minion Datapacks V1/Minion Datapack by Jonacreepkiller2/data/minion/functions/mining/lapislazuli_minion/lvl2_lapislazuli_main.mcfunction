...
execute as @e[tag=lapis_minion,tag=lvl2] at @s if entity @e[distance=..3,tag=lapis.gen,limit=24] run tag @s add lapis.gen_true
...
#main
scoreboard players add @e[tag=lapis_minion,tag=lvl2] lapis_gen_delay 1
execute as @e[scores={lapis_gen_delay=360},tag=lvl2] at @s positioned as @e[distance=..3,tag=!lapis_obfuscated,tag=lapis.gen,sort=random,limit=1] if block ^ ^ ^ air run setblock ^ ^ ^ lapis_ore
execute as @e[scores={lapis_gen_delay=360},tag=lvl2] run scoreboard players add @s lap_ore_counter 1
execute as @e[scores={lap_ore_counter=24},tag=lvl2] at @s run tag @e[distance=..3,tag=lapis_obfuscated,limit=1,sort=random] add lapis_selected
execute as @e[scores={lap_ore_counter=24},tag=lvl2] at @s if entity @e[distance=..3,tag=lapis_selected] run function dp_by_j:mining/lapislazuli/lvl2/lvl2_lapis_mining
execute as @e[scores={lapis_gen_delay=360,lap_ore_counter=1..},tag=lvl2] run scoreboard players set @s lapis_gen_delay 0
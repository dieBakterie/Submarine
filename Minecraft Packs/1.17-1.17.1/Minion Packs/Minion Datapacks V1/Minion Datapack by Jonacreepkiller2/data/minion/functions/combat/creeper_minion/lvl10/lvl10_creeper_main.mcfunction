...
execute as @e[scores={creeper_counter=6},tag=lvl10] if entity @e[tag=creeper_summon_delay,tag=lvl10] run function dp_by_j:combat/creeper_minion/lvl10/lvl10_creeper_kill

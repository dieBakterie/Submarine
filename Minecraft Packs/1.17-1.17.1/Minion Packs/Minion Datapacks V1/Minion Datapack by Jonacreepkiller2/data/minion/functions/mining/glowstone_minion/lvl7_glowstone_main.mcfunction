...
execute as @e[scores={glow_counter=24},tag=lvl7] if entity @e[tag=glowstone_selected] run function dp_by_j:mining/glowstone_minion/glowstone/lvl7/lvl7_glowstone_mining

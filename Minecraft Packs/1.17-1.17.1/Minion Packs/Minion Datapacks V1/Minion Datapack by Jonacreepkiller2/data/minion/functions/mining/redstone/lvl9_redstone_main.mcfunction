...
execute as @e[scores={red_ore_counter=24},tag=lvl9] if entity @e[tag=redstone_selected] run function dp_by_j:mining/redstone_minion/redstone/redstone_minion/redstone/lvl9/lvl9_redstone_mining

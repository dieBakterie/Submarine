...
execute as @e[scores={obsidian_counter=24},tag=lvl9] if entity @e[tag=obsidian_selected] run function dp_by_j:mining/obsidian_minion/obsidian_minion/obsidian/lvl9/lvl9_obsidian_mining

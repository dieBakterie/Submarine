...
execute as @e[tag=gold_minion,tag=lvl7] at @s if entity @e[tag=gold.gen,limit=24,distance=..3] run tag @s add gold.gen_true
...
#main
scoreboard players add @e[tag=gold_minion,tag=lvl7] gold_gen_delay 1
execute as @e[scores={gold_gen_delay=220},tag=lvl7] at @s positioned as @e[distance=..3,tag=!gold_obfuscated,tag=gold.gen,sort=random,limit=1] if block ^ ^ ^ air run setblock ^ ^ ^ gold_ore
execute as @e[scores={gold_gen_delay=220},tag=lvl7] run scoreboard players add @s gold_ore_counter 1
execute as @e[scores={gold_ore_counter=24},tag=lvl7] at @s run tag @e[distance=..3,tag=gold_obfuscated,limit=1,sort=random] add gold_selected
execute as @e[scores={gold_ore_counter=24},tag=lvl7] if entity @e[tag=gold_selected] run function dp_by_j:mining/lvl7/lvl7_gold_mining
execute as @e[scores={gold_gen_delay=220,gold_ore_counter=1..},tag=lvl7] run scoreboard players set @s gold_gen_delay 0
...
execute as @e[scores={glow_counter=24},tag=lvl10] if entity @e[tag=glowstone_selected] run function dp_by_j:mining/glowstone_minion/glowstone/lvl10/lvl10_glowstone_mining

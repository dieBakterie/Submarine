...
execute as @e[scores={glow_counter=24},tag=lvl11] if entity @e[tag=glowstone_selected] run function dp_by_j:mining/glowstone_minion/glowstone/lvl11/lvl11_glowstone_mining

...
execute as @e[scores={zombie_counter=6},tag=lvl1] at @s if entity @e[distance=0..3,tag=zombie_summon_delay,tag=lvl1] run function dp_by_j:combat/lvl1/lvl1_zombie_kill

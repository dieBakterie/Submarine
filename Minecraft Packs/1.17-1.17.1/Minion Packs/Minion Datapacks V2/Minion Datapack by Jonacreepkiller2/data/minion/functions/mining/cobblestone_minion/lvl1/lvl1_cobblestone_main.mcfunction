...
execute as @e[scores={cobble_counter=24}] if entity @e[tag=cobblestone_selected] run function dp_by_j:mining/cobblestone_minion/lvl1/lvl1_cobblestone_mining

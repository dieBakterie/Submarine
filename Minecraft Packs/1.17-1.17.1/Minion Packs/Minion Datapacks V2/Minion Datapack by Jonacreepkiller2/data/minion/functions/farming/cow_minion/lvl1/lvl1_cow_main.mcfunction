...
execute as @a[tag=cow.crafter_lvl1] run give @s tripwire_hook{display:{Name:'{"text":"cow remover"}'}}
...
execute positioned as @e[scores={cow_counter=6},tag=lvl1] at @s if entity @e[distance=0..3,tag=cow_summon_delay,tag=lvl1] run function dp_by_j:farming/cow_minion/cow/lvl1/lvl1_cow_kill

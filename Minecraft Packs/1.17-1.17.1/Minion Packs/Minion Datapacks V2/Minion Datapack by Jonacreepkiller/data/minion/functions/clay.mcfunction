...
execute as @e[type=minecraft:villager,tag=clayminion] at @s run summon armor_stand ~ ~ ~ {DisabledSlots:4144959,NoGravity:1b,ShowArms:1b,Small:1b,Invulnerable:1b,NoBasePlate:1b,ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color:9596948}}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color:9596948}}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color:9596948}}},{id:"minecraft:player_head",Count:1b,tag:{SkullOwner:{Id:[I;1252695985,-2048111482,-1226544339,-177122751],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZDRhMjc5ZTFjYzdkOThmYWE0YjgwY2ZkNGVkMTg2YTFhOTRiNmMxMTkxMGM0ZjdiZDcyMWY4Y2Q0NGI0NTg4YSJ9fX0="}]}}}}],HandItems:[{id:"minecraft:diamond_shovel",Count:1b},{}],Tags:["clayminion"],CustomName:'{"text":"Clay Minion"}'}

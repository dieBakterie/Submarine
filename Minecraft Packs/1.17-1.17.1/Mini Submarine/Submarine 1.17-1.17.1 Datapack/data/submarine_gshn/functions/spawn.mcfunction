summon armor_stand ~ ~ ~ {CustomName:"\"sub\"",Tags:["vehicle","sub","subspawn","sub2"],NoGravity:1b,Marker:1b,Invulnerable:1,NoBasePlate:1,Invisible:1b,ArmorItems:[{},{},{},{id:diamond_hoe,Count:1b,tag:{CustomModelData:1}}],ArmorDropChances:[0.000F,0.000F,0.000F,0.0F],DisabledSlots:2039583,Passengers:[{id:"minecart",CustomName:"\"subseat\"",Tags:["sub2"],Silent:1,Invulnerable:1b}]}

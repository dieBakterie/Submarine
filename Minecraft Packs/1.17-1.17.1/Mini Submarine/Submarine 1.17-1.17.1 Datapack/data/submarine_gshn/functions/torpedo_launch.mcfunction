...
summon armor_stand ^ ^ ^-0.1 {CustomName:"\"subtorpedo\"",NoGravity:1b,Marker:1b,Invulnerable:1,NoBasePlate:1,Invisible:1b,ArmorItems:[{},{},{},{id:diamond_hoe,Count:1b,tag:{custom_model_data:100}}],ArmorDropChances:[0.000F,0.000F,0.000F,0.0F],DisabledSlots:2039583}

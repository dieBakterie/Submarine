execute if entity @s[type=#trains_gshn:undead,tag=!rptrain_ranover] run effect give @s minecraft:instant_health 1 1 true
execute if entity @s[type=!#trains_gshn:undead,tag=!rptrain_ranover] run effect give @s minecraft:instant_damage 1 1 true

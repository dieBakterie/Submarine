...
execute store result score @s rptrain_rotation run data get block ~ ~-3 ~ LastExecution 1
...
execute store result score @s rptrain_pitch run data get block ~ ~-3 ~ SuccessCount -1
execute if entity @s[tag=rptrain_linked] store result score @s rptrain_pitch run data get block ~ ~-3 ~ SuccessCount 1
...
execute if entity @s[tag=!rptrain_reset] store result score @s rptrain_rotation run data get block ~ ~-3 ~ LastExecution 1
execute if entity @s[tag=!rptrain_reset] run scoreboard players add @s rptrain_rotation 180
execute if entity @s[tag=!rptrain_reset,scores={rptrain_rotation=360..}] run scoreboard players remove @s rptrain_rotation 360

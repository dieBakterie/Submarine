...
execute if entity @e[type=armor_stand,name=rptrain_model,tag=rptrain_opendoorright,tag=!rptrain_openeddoorright] as @e[type=armor_stand,name=rptrain_model,tag=rptrain_opendoorright,tag=!rptrain_openeddoorright] at @s run function trains_gshn:model_opendoorright

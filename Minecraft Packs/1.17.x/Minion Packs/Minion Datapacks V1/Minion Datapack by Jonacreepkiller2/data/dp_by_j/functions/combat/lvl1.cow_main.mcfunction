...
execute positioned as @e[scores={cow_counter=6},tag=lvl1] at @s if entity @e[distance=0..3,tag=cow_summon_delay,tag=lvl1] run function dp_by_j:combat/lvl1.cow_kill

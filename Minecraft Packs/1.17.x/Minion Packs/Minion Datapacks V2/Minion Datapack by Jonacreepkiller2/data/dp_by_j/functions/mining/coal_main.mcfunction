...
execute as @s[tag=coal_minion,type=random,limit=1] at @s positioned as @s unless entity @s[distance=..3,tag=coal.gen,limit=24] run function dp_by_j:mining/coal_marker_spawner

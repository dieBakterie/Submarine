...
execute as @e[scores={zombie_counter=6},tag=lvl2] at @s if entity @e[tag=zombie_summon_delay,tag=lvl2,distance=0..3] run function dp_by_j:combat/lvl2.zombie_kill

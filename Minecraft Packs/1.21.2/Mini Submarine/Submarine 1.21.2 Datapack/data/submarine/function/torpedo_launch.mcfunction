...
summon armor_stand ^ ^ ^-0.1 {NoGravity:1b,Invulnerable:1b,Marker:1b,Invisible:1b,NoBasePlate:1b,DisabledSlots:4144959,ArmorItems:[{},{},{},{id:paper,count:1,components:{item_model:"submarine:torpedo"}}],ArmorDropChances:[0.000F,0.000F,0.000F,0.000F],CustomName:'"subtorpedo"'}

summon armor_stand ~ ~ ~ {NoGravity:1b,Invulnerable:1b,Marker:1b,Invisible:1b,NoBasePlate:1b,Tags:["vehicle","sub","subspawn","sub2","color_light_blue"],DisabledSlots:4144959,Passengers:[{id:"minecraft:minecart",NoGravity:1b,Silent:1b,Invulnerable:1b,Tags:["sub2"],CustomName:'"subseat"'}],ArmorItems:[{},{},{},{id:paper,count:1,components:{item_model:"submarine:submarines/light_blue/light_blue_submarine_1"}}],ArmorDropChances:[0.000F,0.000F,0.000F,0.000F],CustomName:'"sub"'}

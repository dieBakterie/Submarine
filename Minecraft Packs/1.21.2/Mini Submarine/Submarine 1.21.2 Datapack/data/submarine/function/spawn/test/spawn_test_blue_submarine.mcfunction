...
execute as @e[name=sub,distance=..8,limit=1] at @s run give @n[type=player,distance=..2] turtle_spawn_egg[custom_name='"Spawn blue Submarine"',lore=['{"bold":false,"color":"#0000AA","italic":false,"obfuscated":false,"strikethrough":false,"text":"A blue submarine that can be used to explore the depths of the ocean.","underlined":false}'],item_model="submarine:submarines/blue/blue_submarine_1",entity_data={id:marker,NoGravity:1b,Silent:1b,Invulnerable:1b,Tags:["color_blue"],CustomName:'{"bold":false,"color":"#0000AA","italic":false,"obfuscated":false,"strikethrough":false,"text":"Spawn blue Submarine","underlined":false}'}] 1

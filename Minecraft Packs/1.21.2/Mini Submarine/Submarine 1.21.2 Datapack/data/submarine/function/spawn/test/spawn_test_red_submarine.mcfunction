...
execute as @e[name=sub,distance=..8,limit=1] at @s run give @n[type=player,distance=..2] turtle_spawn_egg[custom_name='"Spawn red Submarine"',lore=['{"bold":false,"color":"#FF5555","italic":false,"obfuscated":false,"strikethrough":false,"text":"A red submarine that can be used to explore the depths of the ocean.","underlined":false}'],item_model="submarine:submarines/red/red_submarine_1",entity_data={id:marker,NoGravity:1b,Silent:1b,Invulnerable:1b,Tags:["color_red"],CustomName:'{"bold":false,"color":"#FF5555","italic":false,"obfuscated":false,"strikethrough":false,"text":"Spawn red Submarine","underlined":false}'}] 1

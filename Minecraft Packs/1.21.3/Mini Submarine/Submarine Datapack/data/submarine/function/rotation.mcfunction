...
execute as @s[scores={subyawgroup=1}] at @e[name=sub,distance=..2,limit=1,scores={subyawgroup=1}] run function submarine:rotationgroup
execute as @s[scores={subyawgroup=2}] at @e[name=sub,distance=..2,limit=1,scores={subyawgroup=2}] run function submarine:rotationgroup
execute as @s[scores={subyawgroup=3}] at @e[name=sub,distance=..2,limit=1,scores={subyawgroup=3}] run function submarine:rotationgroup
...
execute as @s[x_rotation=-90..-7] unless block ~ ~1.5 ~ #submarine:water run scoreboard players set @s subpitch -1

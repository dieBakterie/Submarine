...
execute as @e[name=sub,distance=..8,limit=1] at @s run give @n[type=player,distance=..10] turtle_spawn_egg[custom_name='"Spawn pink Submarine"',lore=['{"bold":false,"color":"#FFAAFF","italic":false,"obfuscated":false,"strikethrough":false,"text":"A pink submarine that can be used to explore the depths of the ocean.","underlined":false}'],custom_model_data=45,entity_data={id:"minecraft:marker",NoGravity:1b,Silent:1b,Invulnerable:1b,Tags:["color_pink"],CustomName:'{"bold":false,"color":"#FFAAFF","italic":false,"obfuscated":false,"strikethrough":false,"text":"Spawn pink Submarine","underlined":false}'}] 1

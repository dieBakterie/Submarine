...
execute as @e[name=sub,distance=..8,limit=1] at @s run give @n[type=player,distance=..10] turtle_spawn_egg[custom_name='"Spawn magenta Submarine"',lore=['{"bold":false,"color":"#FF55FF","italic":false,"obfuscated":false,"strikethrough":false,"text":"A magenta submarine that can be used to explore the depths of the ocean.","underlined":false}'],custom_model_data=37,entity_data={id:"minecraft:marker",NoGravity:1b,Silent:1b,Invulnerable:1b,Tags:["color_magenta"],CustomName:'{"bold":false,"color":"#FF55FF","italic":false,"obfuscated":false,"strikethrough":false,"text":"Spawn magenta Submarine","underlined":false}'}] 1

...
execute as @e[name=sub,distance=..8,limit=1] at @s run give @n[type=player,distance=..10] turtle_spawn_egg[custom_name='"Spawn yellow Submarine"',lore=['{"bold":false,"color":"#FFFF55","italic":false,"obfuscated":false,"strikethrough":false,"text":"A yellow submarine that can be used to explore the depths of the ocean.","underlined":false}'],custom_model_data=61,entity_data={id:"minecraft:marker",NoGravity:1b,Silent:1b,Invulnerable:1b,Tags:["color_yellow"],CustomName:'{"bold":false,"color":"#FFFF55","italic":false,"obfuscated":false,"strikethrough":false,"text":"Spawn yellow Submarine","underlined":false}'}] 1
